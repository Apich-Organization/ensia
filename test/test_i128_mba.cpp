...
int128_t test_mul128(int128_t a, int128_t b) {
    return a * b;
}

__attribute__((noinline))
int128_t test_shl128(int128_t a, int b) {
    return a << b;
}

__attribute__((noinline))
int128_t test_lshr128(uint128_t a, int b) {
    return a >> b;
}

__attribute__((noinline))
int128_t test_ashr128(int128_t a, int b) {
    return a >> b;
}
...
int main() {
    ...
    std::cout << "[PASS] 128-bit integer MBA & Substitution tests passed!" << std::endl;
    return 0;
}
