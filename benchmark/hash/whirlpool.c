...
// Whirlpool constants
static const uint64_t rc[10] = {0x1823C6E887B8014F, 0x36A6D2F5796F9152,
...
const HashAlgo whirlpoolHashAlgo = {"Whirlpool",
                                    WHIRLPOOL_OID,
...
/**
 * @brief Update the Whirlpool context with a portion of the message being
 * hashed
