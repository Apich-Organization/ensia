...
const uint8_t BLAKE2S256_OID[11] = {0x43, 0x06, 0x01, 0x04, 0x01, 0x8D,
                                    0x3A, 0x0C, 0x02, 0x02, 0x08};

// Common interface for hash algorithms
const HashAlgo blake2s256HashAlgo = {"BLAKE2s-256",
                                     BLAKE2S256_OID,
...
void blake2s256Update(Blake2s256Context *context, const void *data,
                      size_t length) {
  // Digest the data
