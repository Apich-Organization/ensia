 ...
 * @section Description
 *
 * SHA-512/256 is a secure hash algorithm for computing a condensed
 * representation of an electronic message. Refer to FIPS 180-4 for more details
 *
...
const uint8_t SHA512_256_OID[9] = {0x60, 0x86, 0x48, 0x01, 0x65,
                                   0x03, 0x04, 0x02, 0x06};

// Common interface for hash algorithms
const HashAlgo sha512_256HashAlgo = {"SHA-512/256",
                                     SHA512_256_OID,
...
__weak_func error_t sha512_256Compute(const void *data, size_t length,
                                      uint8_t *digest) {
...
/**
 * @brief Update the SHA-512/256 context with a portion of the message being
 * hashed
...
__weak_func void sha512_256Update(Sha512_256Context *context, const void *data,
                                  size_t length) {
