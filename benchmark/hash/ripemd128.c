...
#define GGG(a, b, c, d, x, s)                                                  \
  a += G(b, c, d) + (x) + 0x6D703EF3, a = ROL32(a, s)
#define HHH(a, b, c, d, x, s)                                                  \
  a += H(b, c, d) + (x) + 0x5C4DD124, a = ROL32(a, s)
#define III(a, b, c, d, x, s)                                                  \
  a += I(b, c, d) + (x) + 0x50A28BE6, a = ROL32(a, s)
...
const HashAlgo ripemd128HashAlgo = {"RIPEMD-128",
                                    RIPEMD128_OID,
...
/**
 * @brief Update the RIPEMD-128 context with a portion of the message being
 * hashed
...
void ripemd128Update(Ripemd128Context *context, const void *data,
                     size_t length) {
  size_t n;
