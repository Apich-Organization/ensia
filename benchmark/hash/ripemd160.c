...
#define FF(a, b, c, d, e, x, s)                                                \
  a += F(b, c, d) + (x), a = ROL32(a, s) + (e), c = ROL32(c, 10)
...
const HashAlgo ripemd160HashAlgo = {"RIPEMD-160",
                                    RIPEMD160_OID,
...
/**
 * @brief Update the RIPEMD-160 context with a portion of the message being
 * hashed
