...
const HashAlgo md5HashAlgo = {"MD5",
                              MD5_OID,
                              sizeof(MD5_OID),
                              sizeof(Md5Context),
                              MD5_BLOCK_SIZE,
...
__weak_func error_t md5Compute(const void *data, size_t length,
                               uint8_t *digest) {
...
__weak_func void md5Update(Md5Context *context, const void *data,
                           size_t length) {
  size_t n;
