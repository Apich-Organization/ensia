...
const uint8_t SHA256_OID[9] = {0x60, 0x86, 0x48, 0x01, 0x65,
                               0x03, 0x04, 0x02, 0x01};
...
#if ((defined(MIMXRT1050_CRYPTO_HASH_SUPPORT) &&                               \
      MIMXRT1050_CRYPTO_HASH_SUPPORT == ENABLED) ||                            \
     (defined(MIMXRT1060_CRYPTO_HASH_SUPPORT) &&                               \
      MIMXRT1060_CRYPTO_HASH_SUPPORT == ENABLED) ||                            \
     (defined(MIMXRT1160_CRYPTO_HASH_SUPPORT) &&                               \
      MIMXRT1160_CRYPTO_HASH_SUPPORT == ENABLED) ||                            \
     (defined(MIMXRT1170_CRYPTO_HASH_SUPPORT) &&                               \
...
__weak_func error_t sha256Compute(const void *data, size_t length,
                                  uint8_t *digest) {
...
__weak_func void sha256Update(Sha256Context *context, const void *data,
                              size_t length) {
  size_t n;
