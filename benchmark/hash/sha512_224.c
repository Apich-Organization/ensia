 ...
 * @section Description
 *
 * SHA-512/224 is a secure hash algorithm for computing a condensed
...
const uint8_t SHA512_224_OID[9] = {0x60, 0x86, 0x48, 0x01, 0x65,
                                   0x03, 0x04, 0x02, 0x05};

// Common interface for hash algorithms
const HashAlgo sha512_224HashAlgo = {"SHA-512/224",
                                     SHA512_224_OID,
...
__weak_func error_t sha512_224Compute(const void *data, size_t length,
                                      uint8_t *digest) {
...
/**
 * @brief Update the SHA-512/224 context with a portion of the message being
 * hashed
...
__weak_func void sha512_224Update(Sha512_224Context *context, const void *data,
                                  size_t length) {
