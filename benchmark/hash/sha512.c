...
const uint8_t SHA512_OID[9] = {0x60, 0x86, 0x48, 0x01, 0x65,
                               0x03, 0x04, 0x02, 0x03};

// Common interface for hash algorithms
const HashAlgo sha512HashAlgo = {"SHA-512",
                                 SHA512_OID,
                                 sizeof(SHA512_OID),
...
__weak_func error_t sha512Compute(const void *data, size_t length,
                                  uint8_t *digest) {
...
__weak_func void sha512Update(Sha512Context *context, const void *data,
                              size_t length) {
  size_t n;
