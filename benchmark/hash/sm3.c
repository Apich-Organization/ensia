...
const HashAlgo sm3HashAlgo = {"SM3",
                              SM3_OID,
                              sizeof(SM3_OID),
                              sizeof(Sm3Context),
                              SM3_BLOCK_SIZE,
...
__weak_func error_t sm3Compute(const void *data, size_t length,
                               uint8_t *digest) {
...
__weak_func void sm3Update(Sm3Context *context, const void *data,
                           size_t length) {
  size_t n;
