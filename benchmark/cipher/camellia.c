...
static const uint8_t sbox2[256] = {
    };

// Substitution table 3
static const uint8_t sbox3[256] = {
    };

// Substitution table 4
static const uint8_t sbox4[256] = {
    };

// Camellia128-CBC OID (1.2.392.200011.61.1.1.1.2)
const uint8_t CAMELLIA128_CBC_OID[11] = {0x2A, 0x83, 0x08, 0x8C, 0x9A, 0x4B,
                                         0x3D, 0x01, 0x01, 0x01, 0x02};
// Camellia192-CBC OID (1.2.392.200011.61.1.1.1.3)
const uint8_t CAMELLIA192_CBC_OID[11] = {0x2A, 0x83, 0x08, 0x8C, 0x9A, 0x4B,
                                         0x3D, 0x01, 0x01, 0x01, 0x03};
// Camellia256-CBC OID (1.2.392.200011.61.1.1.1.4)
const uint8_t CAMELLIA256_CBC_OID[11] = {0x2A, 0x83, 0x08, 0x8C, 0x9A, 0x4B,
                                         0x3D, 0x01, 0x01, 0x01, 0x04};
...
error_t camelliaInit(CamelliaContext *context, const uint8_t *key,
  ...
  while (i > 0) {
    ...
    if (m == 0) {
      ...
      context->ks[p->index + 1] =
          (k[(n + 1) % 4] << m) | (k[(n + 2) % 4] >> (32 - m));
    }
