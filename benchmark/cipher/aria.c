...
static const uint32_t c[12] = {0x517CC1B7, 0x27220A94, 0xFE13ABE8, 0xFA9A6EE0,
                               0x6DB14ACC, 0x9E21C820, 0xFF28B1D5, 0xEF5DE2B0,
                               0xDB92371D, 0x2126E970, 0x03249775, 0x04E8C90E};

// ARIA128-ECB OID (1.2.410.200046.1.1.1)
const uint8_t ARIA128_ECB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x01};
// ARIA128-CBC OID (1.2.410.200046.1.1.2)
const uint8_t ARIA128_CBC_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x02};
// ARIA128-CFB OID (1.2.410.200046.1.1.3)
const uint8_t ARIA128_CFB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x03};
// ARIA128-OFB OID (1.2.410.200046.1.1.4)
const uint8_t ARIA128_OFB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x04};
// ARIA128-CTR OID (1.2.410.200046.1.1.5)
const uint8_t ARIA128_CTR_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x05};

// ARIA192-ECB OID (1.2.410.200046.1.1.6)
const uint8_t ARIA192_ECB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x06};
// ARIA192-CBC OID (1.2.410.200046.1.1.7)
const uint8_t ARIA192_CBC_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x07};
// ARIA192-CFB OID (1.2.410.200046.1.1.8)
const uint8_t ARIA192_CFB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x08};
// ARIA192-OFB OID (1.2.410.200046.1.1.9)
const uint8_t ARIA192_OFB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x09};
// ARIA192-CTR OID (1.2.410.200046.1.1.10)
const uint8_t ARIA192_CTR_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x0A};

// ARIA256-ECB OID (1.2.410.200046.1.1.11)
const uint8_t ARIA256_ECB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x0B};
// ARIA256-CBC OID (1.2.410.200046.1.1.12)
const uint8_t ARIA256_CBC_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x0C};
// ARIA256-CFB OID (1.2.410.200046.1.1.13)
const uint8_t ARIA256_CFB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x0D};
// ARIA256-OFB OID (1.2.410.200046.1.1.14)
const uint8_t ARIA256_OFB_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x0E};
// ARIA256-CTR OID (1.2.410.200046.1.1.15)
const uint8_t ARIA256_CTR_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x0F};

// ARIA128-GCM OID (1.2.410.200046.1.1.34)
const uint8_t ARIA128_GCM_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x22};
// ARIA192-GCM OID (1.2.410.200046.1.1.35)
const uint8_t ARIA192_GCM_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x23};
// ARIA256-GCM OID (1.2.410.200046.1.1.36)
const uint8_t ARIA256_GCM_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x24};

// ARIA128-CCM OID (1.2.410.200046.1.1.37)
const uint8_t ARIA128_CCM_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x25};
// ARIA192-CCM OID (1.2.410.200046.1.1.38)
const uint8_t ARIA192_CCM_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x26};
// ARIA256-CCM OID (1.2.410.200046.1.1.39)
const uint8_t ARIA256_CCM_OID[9] = {0x2A, 0x83, 0x1A, 0x8C, 0x9A,
                                    0x6E, 0x01, 0x01, 0x27};

// Common interface for encryption algorithms
const CipherAlgo ariaCipherAlgo = {"ARIA",
                                   sizeof(AriaContext),
