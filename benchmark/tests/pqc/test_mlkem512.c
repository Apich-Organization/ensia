/**
 * @file test_mlkem512.c
 * @brief Benchmark test: MLKEM512 (NIST PQC, code-size measurement only)
 * @note angr-timeout: 600
 * @note SIZE_ONLY: excluded from angr analysis (lattice-based PQC too complex)
 */
/* Self-contained stub: no PQC library sources required (not yet in benchmark
 * dir). This file exists purely to measure code-size overhead of test
 * infrastructure.
 */
...
int main(void) {
  ...
  test_print_result("MLKEM512", 1, g_output, 4);
  return 0;
}
