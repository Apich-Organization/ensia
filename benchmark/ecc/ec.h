...
#elif (BRAINPOOLP160R1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP160R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP160T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP160T1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP192R1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP192R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP192T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP192T1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP224R1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP224R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP224T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP224T1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP256R1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP256R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP256T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP256T1_SUPPORT != DISABLED)
...
#define BRAINPOOLP320R1_SUPPORT DISABLED
       ...
       BRAINPOOLP320R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP320T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP320T1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP384R1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP384R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP384T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP384T1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP512R1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP512R1_SUPPORT != DISABLED)
...
#elif (BRAINPOOLP512T1_SUPPORT != ENABLED &&                                   \
       BRAINPOOLP512T1_SUPPORT != DISABLED)
...
#define EC_MAX_MODULUS_SIZE 10
       ...
       BRAINPOOLP256R1_SUPPORT == ENABLED ||                                   \
