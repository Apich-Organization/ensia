...
const uint8_t SECP192R1_OID[8] = {0x2A, 0x86, 0x48, 0xCE,
                                  0x3D, 0x03, 0x01, 0x01};
...
const uint8_t SECP256R1_OID[8] = {0x2A, 0x86, 0x48, 0xCE,
                                  0x3D, 0x03, 0x01, 0x07};
...
const uint8_t BRAINPOOLP160R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x01};
// brainpoolP160t1 OID (1.3.36.3.3.2.8.1.1.2)
const uint8_t BRAINPOOLP160T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x02};
// brainpoolP192r1 OID (1.3.36.3.3.2.8.1.1.3)
const uint8_t BRAINPOOLP192R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x03};
// brainpoolP192t1 OID (1.3.36.3.3.2.8.1.1.4)
const uint8_t BRAINPOOLP192T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x04};
// brainpoolP224r1 OID (1.3.36.3.3.2.8.1.1.5)
const uint8_t BRAINPOOLP224R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x05};
// brainpoolP224t1 OID (1.3.36.3.3.2.8.1.1.6)
const uint8_t BRAINPOOLP224T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x06};
// brainpoolP256r1 OID (1.3.36.3.3.2.8.1.1.7)
const uint8_t BRAINPOOLP256R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x07};
// brainpoolP256t1 OID (1.3.36.3.3.2.8.1.1.8)
const uint8_t BRAINPOOLP256T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x08};
// brainpoolP320r1 OID (1.3.36.3.3.2.8.1.1.9)
const uint8_t BRAINPOOLP320R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x09};
// brainpoolP320t1 OID (1.3.36.3.3.2.8.1.1.10)
const uint8_t BRAINPOOLP320T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x0A};
// brainpoolP384r1 OID (1.3.36.3.3.2.8.1.1.11)
const uint8_t BRAINPOOLP384R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x0B};
// brainpoolP384t1 OID (1.3.36.3.3.2.8.1.1.12)
const uint8_t BRAINPOOLP384T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x0C};
// brainpoolP512r1 OID (1.3.36.3.3.2.8.1.1.13)
const uint8_t BRAINPOOLP512R1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x0D};
// brainpoolP512t1 OID (1.3.36.3.3.2.8.1.1.14)
const uint8_t BRAINPOOLP512T1_OID[9] = {0x2B, 0x24, 0x03, 0x03, 0x02,
                                        0x08, 0x01, 0x01, 0x0E};
// FRP256v1 OID (1.2.250.1.223.101.256.1)
const uint8_t FRP256V1_OID[10] = {0x2A, 0x81, 0x7A, 0x01, 0x81,
                                  0x5F, 0x65, 0x82, 0x00, 0x01};
...
const EcCurve secp192k1Curve = {
    ...
    // Pre-computed value mu
    {0x8B210276, 0xF096B995, 0xD90D03E8, 0x00000001, 0x00000000, 0x00000000,
     0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve secp192r1Curve = {
    ...
    // Pre-computed value mu
    {0x4B2DD7CF, 0xEB94364E, 0x662107C9, 0x00000000, 0x00000000, 0x00000000,
     0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve secp224k1Curve = {
    ...
    // Pre-computed value mu
    {0x9C18F0E5, 0xAD1D12C0, 0x3CF66A1E, 0x462E5A27, 0xFFFFFFFC, 0xFFFFFFFF,
...
const EcCurve secp224r1Curve = {
    ...
    {0x5C5C2A3D, 0x13DD2945, 0xE0B8F03E, 0xFFFF16A2, 0xFFFFFFFF, 0xFFFFFFFF,
     0xFFFFFFFF},
    // Pre-computed value mu
    {0xA3A3D5C3, 0xEC22D6BA, 0x1F470FC1, 0x0000E95D, 0x00000000, 0x00000000,
     0x00000000, 0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve secp256k1Curve = {
    ...
    {0xD0364141, 0xBFD25E8C, 0xAF48A03B, 0xBAAEDCE6, 0xFFFFFFFE, 0xFFFFFFFF,
     0xFFFFFFFF, 0xFFFFFFFF},
    // Pre-computed value mu
    {0x2FC9BEC0, 0x402DA173, 0x50B75FC4, 0x45512319, 0x00000001, 0x00000000,
...
const EcCurve secp256r1Curve = {
    ...
    // Pre-computed value mu
    {0xEEDF9BFE, 0x012FFD85, 0xDF1A6C21, 0x43190552, 0xFFFFFFFF, 0xFFFFFFFE,
...
const EcCurve secp521r1Curve = {
    ...
    {0x91386409, 0xBB6FB71E, 0x899C47AE, 0x3BB5C9B8, 0xF709A5D0, 0x7FCC0148,
     ...
     0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x000001FF},
    // Pre-computed value mu
    {0x63CDFB88, 0x482470B7, 0x31DC28A2, 0x251B23BB, 0x7B2D17E2, 0x19FF5B84,
     0x6834CA40, 0x3CBC3E20, 0x000002D7, 0x00000000, 0x00000000, 0x00000000,
...
const EcCurve brainpoolP192r1Curve = {
    ...
    // Pre-computed value mu
    {0x10B1AC0A, 0x6639FECF, 0xC2462077, 0x675BC2FD, 0xFF1728C8, 0x500FEA39,
     0x00000001},
    // Curve parameter a
    ...
    // Pre-computed value mu
    {0x5E71F108, 0x3A674578, 0x68D2F9A8, 0x675BC2FF, 0xFF1728C8, 0x500FEA39,
     0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve brainpoolP224r1Curve = {
    ...
    {0x7EC8C0FF, 0x97DA89F5, 0xB09F0757, 0x75D1D787, 0x2A183025, 0x26436686,
     0xD7C134AA},
    // Pre-computed value mu
    {0xB36F5F4F, 0xEF60DC4D, 0x33DA784F, 0x603DE8FD, 0x4E1D543F, 0x8FD22299,
     0x2FC099F7, 0x00000001},
    // Curve parameter a
    {0xCAD29F43, 0xB0042A59, 0x4E182AD8, 0xC1530B51, 0x299803A6, 0xA9CE6C1C,
     0x68A5E62C},
    // Curve parameter b
    {0x386C400B, 0x66DBB372, 0x3E2135D2, 0xA92369E3, 0x870713B1, 0xCFE44138,
     0x2580F63C},
    // Base point G
    {// x-coordinate
     {0xEE12C07D, 0x4C1E6EFD, 0x9E4CE317, 0xA87DC68C, 0x340823B2, 0x2C7E5CF4,
      0x0D9029AD},
     // y-coordinate
     {0x761402CD, 0xCAA3F6D3, 0x354B9E99, 0x4ECDAC24, 0x24C6B89E, 0x72C0726F,
      0x58AA56F7},
     // z-coordinate
     {0x00000001}},
    // Base point order q
    {0xA5A7939F, 0x6DDEBCA3, 0xD116BC4B, 0x75D0FB98, 0x2A183025, 0x26436686,
     0xD7C134AA},
    // Pre-computed value mu
    {0x1C8A5BA1, 0x590A94D3, 0xBEE15BC3, 0x603F1E9F, 0x4E1D543F, 0x8FD22299,
     0x2FC099F7, 0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve brainpoolP256r1Curve = {
    ...
    // Pre-computed value mu
    {0x1180DD0C, 0xB62AE630, 0xFF6A2FA9, 0x9B4F54A0, 0x322A7BF2, 0xBB73ABA8,
     0xA1C55B7E, 0x818C1131, 0x00000001},
    // Curve parameter a
    ...
    {0x974856A7, 0x901E0E82, 0xB561A6F7, 0x8C397AA3, 0x9D838D71, 0x3E660A90,
     0xA1EEA9BC, 0xA9FB57DB},
    // Pre-computed value mu
    {0xCCD10716, 0x50D73B46, 0x5FDF55EA, 0x9BF0088C, 0x322A7BF4, 0xBB73ABA8,
     0xA1C55B7E, 0x818C1131, 0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve brainpoolP320r1Curve = {
    ...
    // Pre-computed value mu
    {0xDDC4B621, 0x2D8C7CAF, 0x3D5AB45A, 0x55D42A20, 0x2237985C, 0x22B851A5,
     0x89AD9837, 0x4195C155, 0xAF1AA120, 0x360E55A5, 0x00000001},
    // Curve parameter a
    {0x7D860EB4, 0x92F375A9, 0x85FFA9F4, 0x66190EB0, 0xF5EB79DA, 0xA2A73513,
     0x6D3F3BB8, 0x83CCEBD4, 0x8FBAB0F8, 0x3EE30B56},
    // Curve parameter b
    {0x8FB1F1A6, 0x6F5EB4AC, 0x88453981, 0xCC31DCCD, 0x9554B49A, 0xE13F4134,
     0x40688A6F, 0xD3AD1986, 0x9DFDBC42, 0x52088394},
    // Base point G
    {// x-coordinate
     {0x39E20611, 0x10AF8D0D, 0x10A599C7, 0xE7871E2A, 0x0A087EB6, 0xF20137D1,
      0x8EE5BFE6, 0x5289BCC4, 0xFB53D8B8, 0x43BD7E9A},
     // y-coordinate
     {0x692E8EE1, 0xD35245D1, 0xAAAC6AC7, 0xA9C77877, 0x117182EA, 0x0743FFED,
      0x7F77275E, 0xAB409324, 0x45EC1CC8, 0x14FDD055},
     // z-coordinate
     {0x00000001}},
    // Base point order q
    {0x44C59311, 0x8691555B, 0xEE8658E9, 0x2D482EC7, 0xB68F12A3, 0xF98FCFA5,
     0xD201E065, 0xE13C785E, 0x36BC4FB7, 0xD35E4720},
    // Pre-computed value mu
    {0xAFA14203, 0x059081EA, 0xA154E856, 0x80461C1B, 0xF8341FE6, 0x22B851A6,
     0x89AD9837, 0x4195C155, 0xAF1AA120, 0x360E55A5, 0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve brainpoolP320t1Curve = {
    ...
    {0xF1B32E24, 0xFCD412B1, 0x7893EC28, 0x4F92B9EC, 0xF6F40DEF, 0xF98FCFA6,
     0xD201E065, 0xE13C785E, 0x36BC4FB7, 0xD35E4720},
    // Curve parameter b
    {0x22340353, 0xB5B4FEF4, 0xB8A547CE, 0x80AAF77F, 0x7ED27C67, 0x064C19F2,
...
const EcCurve brainpoolP384r1Curve = {
    ...
    // Pre-computed value mu
    {0x84A26716, 0x10A03BF6, 0x7A71566F, 0x9047BCE0, 0xF1C4D721, 0x9ED590CE,
     0xCAE56EDE, 0xDDA2C449, 0x3CC6FA65, 0xFF25ADFD, 0x6D8EC6B8, 0xD1B575B1,
     0x00000001},
    // Curve parameter a
    {0x22CE2826, 0x04A8C7DD, 0x503AD4EB, 0x8AA5814A, 0xBA91F90F, 0x139165EF,
     0x4FB22787, 0xC2BEA28E, 0xCE05AFA0, 0x3C72080A, 0x3D8C150C, 0x7BC382C6},
    // Curve parameter b
    {0xFA504C11, 0x3AB78696, 0x95DBC994, 0x7CB43902, 0x3EEB62D5, 0x2E880EA5,
     0x07DCD2A6, 0x2FB77DE1, 0x16F0447C, 0x8B39B554, 0x22CE2826, 0x04A8C7DD},
    // Base point G
    {// x-coordinate
     {0x47D4AF1E, 0xEF87B2E2, 0x36D646AA, 0xE826E034, 0x0CBD10E8, 0xDB7FCAFE,
      0x7EF14FE3, 0x8847A3E7, 0xB7C13F6B, 0xA2A63A81, 0x68CF45FF, 0x1D1C64F0},
     // y-coordinate
     {0x263C5315, 0x42820341, 0x77918111, 0x0E464621, 0xF9912928, 0xE19C054F,
    ...
    // Pre-computed value mu
    {0xF8A71F8A, 0x600ADCCC, 0x7A652109, 0x189FDB46, 0x165031E7, 0xC506F2FE,
     0xCAE56EE1, 0xDDA2C449, 0x3CC6FA65, 0xFF25ADFD, 0x6D8EC6B8, 0xD1B575B1,
     0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve brainpoolP512r1Curve = {
    ...
    // Pre-computed value mu
    {0xE911E8D9, 0x17E2CF84, 0x603556D1, 0x71D621C4, 0x4E73EA8C, 0xE47D9303,
     0x823152C5, 0x42FF2B38, 0xF5BF92F5, 0x666AD8F2, 0xCC44EF09, 0x8373AF60,
     0x03461E1E, 0x15D5EA2F, 0xD6DAEB8A, 0x7F8D7F4E, 0x00000001},
    // Curve parameter a
    {0x77FC94CA, 0xE7C1AC4D, 0x2BF2C7B9, 0x7F1117A7, 0x8B9AC8B5, 0x0A2EF1C9,
     0xA8253AA1, 0x2DED5D5A, 0xEA9863BC, 0xA83441CA, 0x3DF91610, 0x94CBDD8D,
     0xAC234CC5, 0xE2327145, 0x8B603B89, 0x7830A331},
    // Curve parameter b
    {0x8016F723, 0x2809BD63, 0x5EBAE5DD, 0x984050B7, 0xDC083E67, 0x77FC94CA,
     0xE7C1AC4D, 0x2BF2C7B9, 0x7F1117A7, 0x8B9AC8B5, 0x0A2EF1C9, 0xA8253AA1,
     0x2DED5D5A, 0xEA9863BC, 0xA83441CA, 0x3DF91610},
    // Base point G
    {// x-coordinate
     {0xBCB9F822, 0x8B352209, 0x406A5E68, 0x7C6D5047, 0x93B97D5F, 0x50D1687B,
      0xE2D0D48D, 0xFF3B1F78, 0xF4D0098E, 0xB43B62EE, 0xB5D916C1, 0x85ED9F70,
      0x9C4C6A93, 0x5A21322E, 0xD82ED964, 0x81AEE4BD},
     // y-coordinate
     {0x3AD80892, 0x78CD1E0F, 0xA8F05406, 0xD1CA2B2F, 0x8A2763AE, 0x5BCA4BD8,
      0x4A5F485E, 0xB2DCDE49, 0x881F8111, 0xA000C55B, 0x24A57B1A, 0xF209F700,
    ...
    {0x9CA90069, 0xB5879682, 0x085DDADD, 0x1DB1D381, 0x7FAC1047, 0x41866119,
     ...
     0x33C9FC07, 0x3FD4E6AE, 0xDBE9C48B, 0xAADD9DB8},
    // Pre-computed value mu
    {0xDB57DB37, 0x2FAFAC64, 0x15D5C4CE, 0x0EAF0D90, 0x59EE4710, 0x9FF38F5F,
     0x1A235D44, 0xDB9470C6, 0xF5BF92F7, 0x666AD8F2, 0xCC44EF09, 0x8373AF60,
     0x03461E1E, 0x15D5EA2F, 0xD6DAEB8A, 0x7F8D7F4E, 0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve frp256v1Curve = {
    ...
    256,
    // Prime modulus p
    {0xD86E9C03, 0xE8FCF353, 0xABC8CA6D, 0x3961ADBC, 0xCE42435B, 0x10126DE8,
     0x0B3AD58F, 0xF1FD178C},
    // Pre-computed value mu
    {0x9002424F, 0x6ABA3ABF, 0xC20522AE, 0x07B58508, 0x8851C193, 0xF36AF7F5,
     0xC7D2B040, 0x0ED297DC, 0x00000001},
    // Curve parameter a
    {0xD86E9C00, 0xE8FCF353, 0xABC8CA6D, 0x3961ADBC, 0xCE42435B, 0x10126DE8,
     0x0B3AD58F, 0xF1FD178C},
    // Curve parameter b
    {0x7B7BB73F, 0x3075ED96, 0xE4B1A180, 0xDFEC0C9A, 0x4A44C00F, 0x0D4ABA75,
     0x5428A930, 0xEE353FCA},
    // Base point G
    {// x-coordinate
     {0xD98F5CFF, 0x64C97A2D, 0xAF98B701, 0x8C27D2DC, 0x49D42395, 0x31183D47,
      0x56C139EB, 0xB6B3D4C3},
     // y-coordinate
     {0x54062CFB, 0x83115A15, 0xE8E4C9E1, 0x2701C307, 0xF3ECEF8C, 0x1F9271F0,
      0xC8B20491, 0x6142E0F7},
     // z-coordinate
     {0x00000001}},
    // Base point order q
    {0xC6D655E1, 0x1FFDD459, 0x40D2BF94, 0x53DC67E1, 0xCE42435B, 0x10126DE8,
     0x0B3AD58F, 0xF1FD178C},
    // Pre-computed value mu
    {0xE02F4C13, 0xC7CFD1DA, 0xCEAD1E3F, 0xEA1313F7, 0x8851C192, 0xF36AF7F5,
     0xC7D2B040, 0x0ED297DC, 0x00000001},
    // Cofactor
    1,
    // Field modular reduction
...
const EcCurve sm2Curve = {
    ...
    {0x39D54123, 0x53BBF409, 0x21C6052B, 0x7203DF6B, 0xFFFFFFFF, 0xFFFFFFFF,
     0xFFFFFFFF, 0xFFFFFFFE},
    // Pre-computed value mu
    {0xF15149A0, 0x12AC6361, 0xFA323C01, 0x8DFC2096, 0x00000001, 0x00000001,
...
const EcCurve x25519Curve = {
    ...
    {// x-coordinate
     {0x00000009},
     // y-coordinate
     {0x7ECED3D9, 0x29E9C5A2, 0x6D7C61B2, 0x923D4D7E, 0x7748D14C, 0xE01EDD2C,
      0xB8A086B4, 0x20AE19A1},
     // z-coordinate
     {0x00000001}},
    // Base point order q
...
const EcCurve x448Curve = {
    ...
    {// x-coordinate
     {0x00000005},
     // y-coordinate
     {0x457B5B1A, 0x6FD7223D, 0x50677AF7, 0x1312C4B1, 0x46430D21, 0xB8027E23,
      0x8DF3F6ED, 0x60F75DC2, 0xF55545D0, 0xCBAE5D34, 0x58326FCE, 0x6C98AB6E,
      0x95F5B1F6, 0x7D235D12},
     // z-coordinate
     {0x00000001}},
    // Base point order q
...
const EcCurve ed25519Curve = {
    ...
    {0},
    // Curve parameter a
    {0xFFFFFFEC, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
     0xFFFFFFFF, 0x7FFFFFFF},
    // Curve parameter d
    {0x135978A3, 0x75EB4DCA, 0x4141D8AB, 0x00700A4D, 0x7779E898, 0x8CC74079,
...
const EcCurve ed448Curve = {
    ...
    {0x0000001},
    // Curve parameter d
    {0xBAA156B9, 0x243CC32D, 0x58FB61C4, 0xD0809970, 0x264CFE9A, 0x9CCC9C81,
     0x412A12E7, 0x809B1DA3, 0x42A50F37, 0xAD461572, 0x9373A2CC, 0xF24F38C2,
     0x7F0DAF19, 0xD78B4BDC},
    // Base point G
    {// x-coordinate
     {0x3E9C04FC, 0x69871309, 0x8496CD11, 0x9DE732F3, 0xED697224, 0xE21F7787,
      0x728BDC93, 0x0C25A07D, 0xC9296924, 0x1128751A, 0x16C792C6, 0xAE7C9DF4,
      0x70400553, 0x79A70B2B},
     // y-coordinate
     {0x00000001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
      0x80000000, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
      0xFFFFFFFF, 0x7FFFFFFF},
     // z-coordinate
     {0x00000001}},
    // Base point order q
...
void secp160k1FieldInv(const EcCurve *curve, uint32_t *r, const uint32_t *a) {
  ...
  ecFieldMulMod(curve, u, u,
                a); // A^(2^154 - 2^26 - 2^8 - 2^6 - 2^3 - 2^2 - 2^1 - 1)
  ecFieldSqrMod(curve, u, u);
  ecFieldMulMod(curve, u, u,
                a); // A^(2^155 - 2^27 - 2^9 - 2^7 - 2^4 - 2^3 - 2^2 - 1)
  ecFieldSqrMod(curve, u, u);
  ecFieldMulMod(curve, u, u,
                a); // A^(2^156 - 2^28 - 2^10 - 2^8 - 2^5 - 2^4 - 2^3 - 1)
  ecFieldPwr2Mod(curve, u, u, 4);
  ecFieldMulMod(
      curve, r, u,
      a); // A^(2^160 - 2^32 - 2^14 - 2^12 - 2^9 - 2^8 - 2^7 - 2^3 - 2^2 - 3)
}
...
void secp192k1FieldInv(const EcCurve *curve, uint32_t *r, const uint32_t *a) {
  ...
  ecFieldPwr2Mod(curve, u, u, 2);
  ecFieldMulMod(curve, u, u,
                a); // A^(2^190 - 2^30 - 2^10 - 2^6 - 2^5 - 2^4 - 2^1 - 1)
  ecFieldPwr2Mod(curve, u, u, 2);
  ecFieldMulMod(curve, r, u,
                a); // A^(2^192 - 2^32 - 2^12 - 2^8 - 2^7 - 2^6 - 2^3 - 3)
}
...
void secp224k1FieldInv(const EcCurve *curve, uint32_t *r, const uint32_t *a) {
  ...
  ecFieldPwr2Mod(curve, u, u, 2);
  ecFieldMulMod(curve, u, u,
                a); // A^(2^221 - 2^29 - 2^9 - 2^8 - 2^6 - 2^4 - 2^1 - 1)
  ecFieldPwr2Mod(curve, u, u, 2);
  ecFieldMulMod(
      curve, u, u,
      a); // A^(2^223 - 2^31 - 2^11 - 2^10 - 2^8 - 2^6 - 2^3 - 2^1 - 1)
  ecFieldSqrMod(curve, u, u);
  ecFieldMulMod(
      curve, r, u,
      a); // A^(2^224 - 2^32 - 2^12 - 2^11 - 2^9 - 2^7 - 2^4 - 2^2 - 1)
}
...
void secp256k1FieldInv(const EcCurve *curve, uint32_t *r, const uint32_t *a) {
  ...
  ecFieldPwr2Mod(curve, u, u, 2);
  ecFieldMulMod(curve, u, u,
                a); // A^(2^253 - 2^29 - 2^6 - 2^5 - 2^4 - 2^3 - 2^1 - 1)
  ecFieldSqrMod(curve, u, u);
  ecFieldMulMod(curve, u, u,
                a); // A^(2^254 - 2^30 - 2^7 - 2^6 - 2^5 - 2^4 - 2^2 - 1)
  ecFieldPwr2Mod(curve, u, u, 2);
  ecFieldMulMod(curve, r, u,
                a); // A^(2^256 - 2^32 - 2^9 - 2^8 - 2^7 - 2^6 - 2^4 - 3)
}
