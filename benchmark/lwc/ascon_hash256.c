...
const HashAlgo asconHash256HashAlgo = {"Ascon-Hash256",
                                       ASCON_HASH256_OID,
...
__weak_func error_t asconHash256Compute(const void *data, size_t length,
                                        uint8_t *digest) {
...
/**
 * @brief Update the Ascon-Hash256 context with a portion of the message being
 * hashed
