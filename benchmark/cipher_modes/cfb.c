...
__weak_func error_t cfbEncrypt(const CipherAlgo *cipher, void *context,
...
__weak_func error_t cfbDecrypt(const CipherAlgo *cipher, void *context,
                               uint_t s, uint8_t *iv, const uint8_t *c,
