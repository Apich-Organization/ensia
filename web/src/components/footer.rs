    ...
    view! {
        <footer class="footer page-wrap">
            ...
            <div class="footer-links">
                ...
                <a href="https://github.com/Apich-Organization/ensia" target="_blank" rel="noopener noreferrer">
                    "Source"
                </a>
                <a href="https://github.com/Apich-Organization/ensia/issues" target="_blank" rel="noopener noreferrer">
                    "Issues"
                </a>
