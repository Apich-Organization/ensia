        ...
        <nav class="nav">
            <div class="nav-inner">
                ...
                <div class="nav-links">
                    ...
                    <button
                        class="nav-link"
                        class:active=move || page.get() == Page::Algorithms
                        on:click=go(Page::Algorithms)
                    >
                        "Algorithms"
                    </button>
                    <button
                ...
                <div class="nav-right">
                    ...
                    <div class="theme-pill">
                        <button
                            class="theme-btn"
                            class:active=move || theme.get() == Theme::Mist
                            on:click=move |_| theme.set(Theme::Mist)
                        >"Mist"</button>
                        <button
                            class="theme-btn"
                            class:active=move || theme.get() == Theme::Dusk
                            on:click=move |_| theme.set(Theme::Dusk)
                        >"Dusk"</button>
                    </div>
                </div>
            </div>
