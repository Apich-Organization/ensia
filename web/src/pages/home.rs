        ...
        <section class="section page-wrap">
            ...
            <div class="pipeline-steps">
                <PipelineStep n="1" label="AntiHooking & AntiClassDump (module)"
                    detail="Dual-defense AntiHook (Entry Prologue Guard + Scattered In-Flight Auditing against E9/EB/CC/68/FF 25/48 B8 and ARM64 branch stubs), direct syscall bypass, 3-tier anti-taint engine (LUT, bit laundering, vector diffusion), and ObjC metadata scrambling." />
                <PipelineStep n="2" label="FunctionWrapper (module)"
                    detail="Polymorphic proxy wrappers with frame-depth mutation, argument XOR shuffling, return value masking, and enforced NoInline/OptimizeNone to destroy static call-graph topologies before callsite lowering." />
                ...
                <PipelineStep n="7" label="Per-Function Transformations (a-g)"
                ...
                <PipelineStep n="8" label="ConstantEncryption Phase 2 (module)"
                ...
                <PipelineStep n="9" label="IndirectBranch (module)"
                ...
                <PipelineStep n="10" label="Sentinel Cleanup & Sanitization (module)"
                    detail="Erases internal compilation markers (ensia_*) before symbol scrambling, ensuring no sentinel declarations survive in the module." />
                <PipelineStep n="11" label="FeatureElimination (module)"
                    detail="Strips DWARF debug metadata, anonymizes TU paths to single-character identifiers, erases llvm.ident, clears COMDATs, internalizes ODR linkages, and scrambles private/internal symbols (_f<hex>, _v<hex>, _a<hex>)." />
